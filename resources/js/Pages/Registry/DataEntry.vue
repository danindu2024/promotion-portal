        ...
        <div class="max-w-5xl mx-auto">
            ...
            >
                ...
                <div ref="alertArea">
                    <div
                        v-if="successMsg"
                        class="mb-6 p-4 bg-green-50 text-green-700 border border-green-200 rounded-md flex items-center"
                    >
                        <svg
                    ...
                    <div
                        v-if="errorMsg"
                        class="mb-6 p-4 bg-red-50 text-red-700 border border-red-200 rounded-md flex items-center"
                    >
                        <svg
                            class="w-5 h-5 mr-2 flex-shrink-0"
                            fill="currentColor"
